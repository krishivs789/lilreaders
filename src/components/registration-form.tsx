...
export default function RegistrationForm() {
  ...
  const goToPrevPage = () => {
    if (currentPage > 0 && flipBookRef.current?.pageFlip) {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #6367FF 0%, #8494FF 100%)' }}>
        <div className="bg-white/20 backdrop-blur-xl rounded-3xl p-8 sm:p-12 max-w-md w-full text-center shadow-2xl border border-white/30">
  ...
  return (
    <div className="min-h-screen p-3 sm:p-4 md:p-6 lg:p-8 font-form" style={{ backgroundImage: 'linear-gradient(135deg, #6367FF 0%, #8494FF 100%)', backgroundAttachment: 'fixed' }}>
      ...
      <div className="max-w-5xl mx-auto relative w-full sm:w-[90%]" style={{ zIndex: 1 }}>
